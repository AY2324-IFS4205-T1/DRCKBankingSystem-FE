...
export async function middleware(request) {
  ...
  //const originalPath = "/customer/dashboard"; // Replace with actual path
  const redirectUrl = `/authorization?originalPath=${pathname}`;
...
export const config = {
  matcher: [
    ...
    "/((?!_next/static|_next/image|images/|favicon.ico|staff/login|customer/login|customer/register|api/|ip|authorization).{1,})",
  ],
};
